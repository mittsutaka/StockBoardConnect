...
namespace StockBoardConnect.Data.Migrations
{
    ...
    [Migration("20210531150834_AddUsersDisplayName")]
    partial class AddUsersDisplayName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockBoardConnect.Data.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StockBoardConnect.Data.PostLike", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StockBoardConnect.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StockBoardConnect.Data.FavoriteCompany", b =>
                {
                    b.HasOne("StockBoardConnect.Data.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("StockBoardConnect.Data.PostLike", b =>
                {
                    b.HasOne("StockBoardConnect.Data.Post", "Post")
                        .WithMany("PostLikes")
